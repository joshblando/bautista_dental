      ...
      <table class="table table-striped">
        <tr>
          <td class="text-center">
            ...
            <span class="badge" style="background:#860938 ;color: #860938;">...</span><small> &nbsp&nbspAPPROVED&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</small>
            <span class="badge" style="background:#f21818 ;color: #f21818;">...</span><small> &nbsp&nbspCANCELED</small>
          </td>
        </tr>
      </table>
    </div>
